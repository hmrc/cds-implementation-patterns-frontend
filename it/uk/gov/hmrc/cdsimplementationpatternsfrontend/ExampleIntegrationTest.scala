package uk.gov.hmrc.cdsimplementationpatternsfrontend
...
class ExampleIntegrationTest extends WordSpec with Matchers with ServiceSpec  {
  ...
  "This integration test" should {
    "start services via smserver" in {
      ...
      val response = wsClient.url(resource("/cds-implementation-patterns-frontend/hello-world")).get.futureValue
