...
import uk.gov.customs.test.{AuthenticationBehaviours, CustomsSpec}
import uk.gov.hmrc.play.bootstrap.controller.BaseController

import scala.concurrent.Future

class ActionsSpec extends CustomsSpec with AuthenticationBehaviours {

  val errorHandler = component[ErrorHandler]
  val actions = new ActionsImpl(authConnector, errorHandler, component[Configuration], component[Environment])
